                ...
                workers.push(tokio::spawn(async move {
                    ...
                    if nf.is_some() {
                            ...
                            .await
                        {
                            ...
                            let value = wallet_txns.write().await.mark_txid_nf_spent(
                                txid,
                                &nf,
                                &spent_txid,
                                spent_at_height,
                            ...
                            // Send the future Tx to be fetched too, in case it has only spent nullifiers and not received any change
